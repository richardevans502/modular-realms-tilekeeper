...
export const SAVED_LAYOUT_METADATA_MIGRATION_SQL = `ALTER TABLE saved_layouts ADD COLUMN name TEXT NOT NULL DEFAULT 'Untitled layout';
...
export const SAVED_LAYOUT_METADATA_MIGRATION: DbMigration = {
  id: '003_saved_layout_metadata',
  schemaVersion: 3,
  productVersion: '0.3',
  sql: SAVED_LAYOUT_METADATA_MIGRATION_SQL,
};

export const MIGRATIONS: DbMigration[] = [INITIAL_MIGRATION, INVENTORY_MIGRATION, SAVED_LAYOUT_METADATA_MIGRATION];
